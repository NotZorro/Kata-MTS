...
| ADR.02 | В качестве архитектурного стиля будет использоваться микросервисная архитектура. Подробнее в [ADR.02 Выбор архитектурного стиля](../main/ADR/ADR02ArchStyle.md)                                     |
| ADR.03 | В проекте будет использовтаься графовая система хранения данных для хранения информации о доступов к статьям. Подробнее в [ADR.03 Выбор системы хранения для обеспечения доступа](../main/ADR/ADR03Storage.md) |
