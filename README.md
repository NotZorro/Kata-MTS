...
| ADR.03 | В проекте будет использовтаься графовая система хранения данных для хранения информации о доступов к статьям. Подробнее в [ADR.02 Выбор системы хранения для обеспечения доступа](../ADR/ADR03Storage.md)             |
